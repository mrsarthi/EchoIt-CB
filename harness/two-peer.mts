/**
 * Can two users actually talk to each other?
 *
 * Spawns two headless peers as separate OS processes and drives them over
 * stdio. Everything asserted here crosses a real Iroh/QUIC connection.
 *
 *   npm run test:two-peer
 *
...
await scenario('Two paired peers exchange messages over real QUIC', async () => {
